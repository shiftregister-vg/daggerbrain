	...
	<main class="relative min-h-[calc(100dvh-var(--navbar-height,3.5rem))] overflow-hidden">
		...
		>
			<section class="mt-4 flex flex-col items-center gap-6 text-center">
				...
				<p class="max-w-[560px]">
					Build encounters faster with adversaries, environments, and a Battle Points calculator all
					in one place. With notes, editable adversaries and environments, and dice rolling built
					in, creating balanced encounters is simple.
				</p>
				<button
					type="button"
		...
		<div class="relative mb-8 w-full bg-background/90 shadow-xl">
			<div class="mx-auto flex max-w-xl flex-col items-center gap-4 px-4 pt-6 pb-8 text-center">
				...
				<p>
					From social encounters, to massive combats, Daggerlore helps GMs organize encounter
