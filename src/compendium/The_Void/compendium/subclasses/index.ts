			...
			features: [
				{
					title: 'Shadowed Grit',
					description_html:
						'When you succeed on an Action Roll with Fear, you can spend a Hope to clear a Stress.',
					character_modifiers: [],
					weapon_modifiers: []
				},
				{
		...
		specialization_card: {
			features: [
				...
				},
				{
					...
					description_html:
						'While you have any Archangels summoned, Hopeful Strike deals **1d12** extra damage instead of **1d10**.',
					character_modifiers: [],
					weapon_modifiers: []
				},
				{
